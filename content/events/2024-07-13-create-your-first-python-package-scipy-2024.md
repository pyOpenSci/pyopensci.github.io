...
date: '2024-07-13'
lastmod: ''
excerpt: Python packaging can be tricky to navigate. pyOpenSci will lead a workshop
  on creating your first Python package at SciPy 2024. The goal of this workshop is
  to help scientists learn how to package and make code installable and shareable.
  Read on to learn more!
image:
  src: images/headers/scipy-2024-workshop.png
  alt: 'Workshop: pyOpenSci @ SciPy 2024--Create your first Python package'
event:
  start_date: '2024-07-13'
  location: Online
  event_type: training
aliases:
- "/events/create-first-python-package-scipy-2024.html"
---
...
[<i class="fas fa-hand-point-right"></i> Click here for setup instructions.](https://github.com/pyOpenSci/code-to-module-workshop/tree/cf9e7d9937c10bde9ee03075ebe78eb7a605f549)## Workshop agenda
