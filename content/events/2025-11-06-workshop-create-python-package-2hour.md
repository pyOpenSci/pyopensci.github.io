...
date: '2025-11-06'
lastmod: '2025-09-08'
excerpt: Turn your Python code into a professional package that others can easily
  install, use, and contribute to. Learn the complete packaging workflow with hands-on
  demos and proven templates.
image:
  src: images/headers/pyopensci-sustainability.png
  alt: 'From Zero to Python Package: A 2-Hour Python Packaging Workshop'
event:
