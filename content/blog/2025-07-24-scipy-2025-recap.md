...
date: '2025-07-24'
type: blog
excerpt: Explore pyOpenSci’s highlights from SciPy 2025—from Python packaging workshops
  and talks to first-time contributions, collaboration, and open science in action.
author: pyopensci
blog_topic: community
toc: true
comments: true
url: "/blog/scipy-2025-recap.html"
lastmod: '2025-05-06'
image:
  src: images/headers/pyopensci-scipy-2025.png
  alt: SciPy 2025 conference graphic highlighting community, code, and culture
---

{{< figure src="images/events/scipy-2025/pixi-workshop.png" alt="A room full of attendees at the pyOpenSci packaging workshop during SciPy 2025, all seated and coding on laptops." >}}
...
{{< figure src="images/events/scipy-2025/bof-discussions-pyopensci.png" alt="Small group discussion at pyOpenSci's Packaging Pain Points BoF session at SciPy 2025, with participants seated in a circle sharing insights." >}}
...
{{< figure src="images/events/scipy-2025/pyopensci-python-packaging-workshop.png" alt="A woman Leah Wasser, smiling at the podium while preparing to present at a pyOpenSci workshop at SciPy 2025, with attendees gathered behind her." >}}
...
{{< figure src="images/events/scipy-2025/lightning-talk-song.png" alt="Add alt" >}}
