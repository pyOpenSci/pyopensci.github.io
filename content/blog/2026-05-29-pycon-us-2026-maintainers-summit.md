---
title: 'Tools Track, GenAI Bof and Roundtables: This year''s PyCon US Maintainer Summit
  was something special'
date: '2026-05-29'
type: blog
excerpt: As a co-organizer of the PyCon US Maintainer Summit, Leah Wasser reflects
...
lastmod: '2026-05-29'
image:
  src: images/blog/2026/pycon-us-2026-maintainers-summit-organizers.png
...
{{< figure src="images/blog/2026/pycon-us-2026-maintainers-summit-organizers.png" alt="Maintainer Summit co-organizers Leah Wasser, Inessa Pawson, and Mariatta Wijaya smile together for a selfie on an outdoor patio at PyCon US in Long Beach, wearing conference lanyards." caption="Maintainer Summit co-organizers Leah Wasser, Inessa Pawson, and Mariatta Wijaya at PyCon US in Long Beach." >}}
...
{{< figure src="images/blog/2026/pycon-us-2026-maintainers-summit-room.png" alt="A wide view of the PyCon US Maintainer Summit in Long Beach, with dozens of maintainers seated at round tables, many with open laptops, listening to a session." >}}
...
This year, roundtable topics included packaging led by [Zanie Blue](https://github.com/zanieb) from uv and [Cary Hawkins](https://github.com/cjames23) from Hatch, security led by [Mike Fiedler](https://github.com/miketheman) from the Python Software Foundation, and AI tools in open source led by the incredible [Carol Willing](https://github.com/willingc).
...
{{< figure src="images/blog/2026/pycon-us-2026-maintainers-summit-roundtables.png" alt="Two maintainers sit side by side at a round table during the PyCon US Maintainer Summit, focused on a session with laptops and conference lanyards on the table." >}}

## The most electric moment

Our Generative AI Birds of a Feather session, co-hosted with [Jackie Kazil](https://github.com/jackiekazil), was an energizing addition to this year's summit. Jackie reached out to us about hosting this part of the day. Maintainers everywhere are feeling overwhelmed and drained by the pace of AI change. Now more than ever, protecting our mental health and making space to connect, problem-solve together, and support each other matters.

{{< figure src="images/blog/2026/pycon-us-2026-maintainers-summit-genai-bof.png" alt="Jackie Kazil co-hosts the Generative AI Birds of a Feather session at the PyCon US Maintainer Summit, with a live Mentimeter poll on screen asking maintainers how useful they find GenAI in their workflows." >}}
...
{{< figure src="images/blog/2026/pycon-us-2026-maintainers-summit-discussion.png" alt="Two attendees have a focused one-on-one discussion at a table during the PyCon US Maintainer Summit, leaning in as they talk through a shared challenge." >}}
